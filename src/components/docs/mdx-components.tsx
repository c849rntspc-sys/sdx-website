...
function H1(props: ComponentPropsWithoutRef<'h1'>) {
  return <h1 className="text-3xl font-bold text-navy-900 mt-2 mb-6" {...props} />;
}

function H2(props: ComponentPropsWithoutRef<'h2'>) {
  return (
    <h2
      className="text-2xl font-semibold text-navy-900 mt-10 mb-4 pb-2 border-b border-gray-100"
      {...props}
    />
  );
}
...
function H3(props: ComponentPropsWithoutRef<'h3'>) {
  return <h3 className="text-xl font-semibold text-navy-900 mt-8 mb-3" {...props} />;
}

function H4(props: ComponentPropsWithoutRef<'h4'>) {
  return <h4 className="text-lg font-semibold text-navy-900 mt-6 mb-2" {...props} />;
}

function P(props: ComponentPropsWithoutRef<'p'>) {
  return <p className="text-text-secondary leading-relaxed mb-4" {...props} />;
}
...
function UL(props: ComponentPropsWithoutRef<'ul'>) {
  return <ul className="list-disc pl-6 mb-4 space-y-2 text-text-secondary" {...props} />;
}

function OL(props: ComponentPropsWithoutRef<'ol'>) {
  return <ol className="list-decimal pl-6 mb-4 space-y-2 text-text-secondary" {...props} />;
}
...
function Blockquote(props: ComponentPropsWithoutRef<'blockquote'>) {
  return (
    <blockquote
      className="border-l-4 border-primary-500 pl-4 italic text-text-secondary my-4"
      {...props}
    />
  );
}
...
function InlineCode(props: ComponentPropsWithoutRef<'code'>) {
  return (
    <code
      className="bg-gray-100 text-navy-900 px-1.5 py-0.5 rounded text-sm font-mono"
      {...props}
    />
  );
}
...
function Pre(props: ComponentPropsWithoutRef<'pre'>) {
  return (
    <pre
      className="bg-navy-900 text-gray-100 rounded-xl p-4 overflow-x-auto mb-6 text-sm font-mono"
      {...props}
    />
  );
}
...
function TH(props: ComponentPropsWithoutRef<'th'>) {
  return (
    <th
      className="text-left font-semibold text-navy-900 p-3 border-b-2 border-gray-200 bg-gray-50"
      {...props}
    />
  );
}
...
function TD(props: ComponentPropsWithoutRef<'td'>) {
  return (
    <td className="p-3 border-b border-gray-100 text-text-secondary" {...props} />
  );
}
